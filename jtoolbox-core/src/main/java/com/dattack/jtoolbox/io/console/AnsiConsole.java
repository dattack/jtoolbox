...
public class AnsiConsole {
     ...
     */
    public static void print(final AnsiStyle style, final String text, final Object... args) {
        print(style);
     ...
     *            arguments referenced by the format specifiers in the format string
     */
    public static void printAndReset(final AnsiStyle style, final String text, final Object... args) {
        print(style);
        System.out.format(text, args);
     ...
     *            arguments referenced by the format specifiers in the format string
     */
    public static void println(final AnsiStyle style, final String text, final Object... args) {
        print(style);
        System.out.format(text, args);
        System.out.println();
    }
     ...
     *            arguments referenced by the format specifiers in the format string
     */
    public static void printlnAndReset(final AnsiStyle style, final String text, final Object... args) {
        print(style);
        System.out.format(text, args);
