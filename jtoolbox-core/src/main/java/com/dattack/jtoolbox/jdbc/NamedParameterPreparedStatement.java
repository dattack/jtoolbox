...
public final class NamedParameterPreparedStatement extends DelegatingPreparedStatement {
    ...
    public static NamedParameterPreparedStatement build(final Connection connection, final String sql)
        ...
        return new NamedParameterPreparedStatement(connection.prepareStatement(//
                ...
                preparedStatementConfig, computeDriverType(connection));
    }
    ...
    private static DriverType computeDriverType(final Connection connection) throws SQLException {
    ...
    public void setClob(final String parameterName, final String value) throws SQLException {
        if (driverType.equals(DriverType.ORACLE)) {
            if (StringUtils.length(value) < 4_000) { // Magic number!
